        ...
        >
          ...
          <Slide transition={["zoom", "fade"]} bgColor="primary">
            ...
            <List>
              <Appear>
                <ListItem>
                  Default React Components - View, Text, Image, etc
                </ListItem>
              </Appear>
              <Appear>
                <ListItem>Style Sheet support, including flexbox</ListItem>
              </Appear>
              <Appear>
...
AppRegistry.registerComponent('AwesomeProject', () => JustifyContentBasics);
          `}
            ...
            <Appear>
              <div>
                ...
                <Link textColor="tertiary" href="http://flexboxfroggy.com/">
          ...
          <Slide transition={["slide"]}>
            ...
            <List>
              ...
              <Appear>
                <ListItem>Raw XHR implemented if required</ListItem>
              </Appear>
              <Appear>
          ...
          <Slide transition={["slide"]}>
            <Text textColor="tertiary">Installing dependencies</Text>
...
`.trim()}
          ...
          <Slide transition={["slide"]}>
            <Text textColor="tertiary">JavaScript Testing - Jest</Text>
            <List>
              <Appear>
              ...
              <Appear>
                <ListItem>Mocking functions, imports, network calls</ListItem>
              </Appear>
              <Appear>
          ...
          <Slide transition={["slide"]}>
            ...
            <List>
              <Appear>
                <ListItem>
                  Animations - Precomputed and Optimised natively
                </ListItem>
              </Appear>
              <Appear>
              ...
              <Appear>
                <ListItem>react-native-workers / native</ListItem>
              </Appear>
              <Appear>
                <ListItem>Inbuilt performance tooling</ListItem>
              </Appear>
              <Appear>
                <ListItem>Android - systrace, iOS Instruments</ListItem>
              </Appear>
            </List>
          </Slide>
          ...
          <Slide transition={["slide"]}>
            <Text textColor="tertiary">Example: Payment Module</Text>
            <CodePane
              lang="java"
          ...
          <Slide transition={["slide"]}>
            <Text textColor="tertiary">Example: React Method</Text>
            <CodePane
              lang="java"
          ...
          <Slide transition={["slide"]}>
            <Text textColor="tertiary">Example: Usage</Text>
            <CodePane
              lang="jsx"
          ...
          <Slide transition={["slide"]}>
            <Text textColor="tertiary">Custom iOS/Android Views</Text>
          </Slide>

          <Slide transition={["slide"]}>
            <Text textColor="tertiary">Platform-Specific Components</Text>
...
`.trim()}
          ...
          <Slide transition={["slide"]}>
            <Text textColor="tertiary">Platform-Specific Styles</Text>
...
`.trim()}
          ...
          >
            ...
            <Appear>
              <Text textColor="quartenary">The one thing I disliked</Text>
            </Appear>
          </Slide>
          ...
          <Slide transition={["slide"]}>
            ...
            <List>
              ...
              <Appear>
                <ListItem>Facebook - NavigationExperimental</ListItem>
              </Appear>
              <Appear>
                <ListItem>wix - react-native-navigation</ListItem>
              </Appear>
              <Appear>
                <ListItem>aksonov - react-native-router-flux</ListItem>
              </Appear>
              <Appear>
                <ListItem>ReactTraining - react-router (4.0 beta)</ListItem>
              </Appear>
              <Appear>
          ...
          <Slide transition={["slide"]}>
            <Text textColor="tertiary">A Single point of read-only truth</Text>
          </Slide>
          ...
          <Slide transition={["slide"]}>
            ...
            <Layout>
              <Fill>
                <Image className="show-case__logo" src={logos.airbnb} />
              ...
              <Fill>
                <Image className="show-case__logo" src={logos.gyroscope} />
            ...
            <Layout>
              <Fill>
                <Image className="show-case__logo" src={logos.instagram} />
                <Text textColor="grey">Instagram</Text>
              </Fill>

              <Fill>
                <Image className="show-case__logo" src={logos.robin} />
                <Text textColor="grey">Round Robin</Text>
              </Fill>

              <Fill>
                <Image className="show-case__logo" src={logos.vogue} />
